...
if 1:
    ...
    desc += '-/content/drive/My Drive/Batik-StyleGAN/batik_tf_records';     dataset = EasyDict(tfrecord_dir='/content/drive/My Drive/Batik-StyleGAN/batik_tf_records', resolution=128); train.mirror_augment = False
